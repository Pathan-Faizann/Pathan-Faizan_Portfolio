...
//                 playsInline
//                 preload="auto"
//                 className="h-full w-full object-cover filter grayscale contrast-[1.12] brightness-[0.88] transition-all duration-[1.8s] ease-[cubic-bezier(0.76,0,0.24,1)] group-hover:grayscale-0 group-hover:scale-105 group-hover:brightness-100 group-hover:contrast-105"
//               />
//             ) : (
//               <Image
//                 src={src}
