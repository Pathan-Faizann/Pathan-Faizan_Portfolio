 ...
 */
const HeroTitle = React.forwardRef<HTMLHeadingElement>(function HeroTitle(
  _props,
  ref
) {
  ...
  return (
    ...
    >
      <div className="w-[78vw] sm:w-[64vw] md:w-[50vw] lg:ml-70 lg:w-[38vw] xl:w-[34vw] max-w-[640px]">
