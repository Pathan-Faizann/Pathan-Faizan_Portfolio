...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Navigation Links */}
      <nav className="flex flex-wrap lg:gap-12! gap-3! lg:justify-end justify-around items-center w-full lg:w-auto sm:gap-6 md:gap-10 pointer-events-auto ml-auto md:ml-0">
        {navItems.map((item) => (
          <button
            key={item.id}
